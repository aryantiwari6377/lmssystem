...
function Verbaltest() {
  ...
  return (
        ...
        <div className='md:w-1/2 ml-3 md:ml-8'>
            <h2 className='font-bold text-3xl mb-3'>Abstract Reasoning Test</h2>
        <p className='items-center'>Alison's Abstract Reasoning Test will help you gauge your ability to analyse and solve unfamiliar problems that do not rely on prior knowledge or experience. This aptitude is critical across multiple fields, as individuals with strong abstract reasoning skills use fluid intelligence and lateral thinking to solve problems in daily life. Once you have taken this assessment, you should complete the Verbal and Numerical Reasoning assessments as well.  </p>
